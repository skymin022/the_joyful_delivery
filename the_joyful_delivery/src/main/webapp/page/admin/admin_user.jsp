...
<body>
	<div class="wrapper">
		...
		<form action="<%=root%>/admin/user">
			<div class="ad_search">
				<ul>     
					<li><input name="where" id="userNo"   value="idx"   type="radio"/><label for="userNo">회원번호</label></li>
					<li><input name="where" id="userName" value="username" type="radio"/><label for="userName">이름</label></li>
					<li><input name="where" id="userId"   value="ID"   type="radio"/><label for="userId">아이디</label></li>
					<li><input name="where" id="userEma"  value="eamil"  type="radio"/><label for="userEma">이메일</label></li>
					<li><input name="where" id="userPho"  value="p_number"  type="radio"/><label for="userPho">전화번호</label></li>
					<li><input name="where" id="userAdd"  value="address"  type="radio"/><label for="userAdd">주소</label></li>
					<li><input name="where" id="userBir"  value="birth"  type="radio"/><label for="userBir">생년월일</label></li>
				</ul>
				<div class="line"></div>
